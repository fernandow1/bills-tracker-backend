 ...
 */
module.exports = class Migrations1767564245677 {
  name = 'Migrations1767564245677';
  ...
  async up(queryRunner) {
    ...
    await queryRunner.query(`
            ALTER TABLE \`bill\`
            ADD CONSTRAINT \`FK_6498532ac094ed754c680d064e1\` FOREIGN KEY (\`id_user\`) REFERENCES \`user\`(\`id\`) ON DELETE RESTRICT ON UPDATE CASCADE
        `);
  }

  async down(queryRunner) {
    await queryRunner.query(`
            ALTER TABLE \`bill\` DROP FOREIGN KEY \`FK_6498532ac094ed754c680d064e1\`
        `);
    await queryRunner.query(`
