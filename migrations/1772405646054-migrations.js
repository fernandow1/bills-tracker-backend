 ...
 */
module.exports = class Migrations1772405646054 {
  name = 'Migrations1772405646054';

  async up(queryRunner) {
    await queryRunner.query(`
            ALTER TABLE \`payment_method\`
            ADD \`uuid\` binary(16) NULL AFTER \`id\`
        `);
    await queryRunner.query(`
            ALTER TABLE \`payment_method\`
            ADD UNIQUE INDEX \`IDX_8aa6ca0f30ddb213477a2bb577\` (\`uuid\`)
        `);
    await queryRunner.query(`
  ...
  async down(queryRunner) {
    ...
    await queryRunner.query(`
        ...
        `);
    await queryRunner.query(`
            ALTER TABLE \`payment_method\` DROP INDEX \`IDX_8aa6ca0f30ddb213477a2bb577\`
        `);
    await queryRunner.query(`
            ALTER TABLE \`payment_method\` DROP COLUMN \`uuid\`
        `);
  }
};
