...
describe('ExtractBillDataFromImage Use Case', () => {
  ...
  it('should successfully extract bill items from an image buffer and run matchers', async () => {
    ...
    const mockCategories: any[] = [{ id: 1, name: 'Limpieza' }, { id: 2, name: 'Comida' }];
    ...
    expect(mockMatchOrCreateProductFromAlias.execute).toHaveBeenCalledWith(10, 'TEST PRODUCT 1', 'Test Product', 1, 1);
